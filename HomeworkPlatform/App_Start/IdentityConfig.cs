...
namespace HomeworkPlatform
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<PlatformIdentityContext>().Users));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var manager = new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<PlatformIdentityContext>().Roles));
